        ...
        <View style={styles.container}>
            ...
            <View style={styles.footer}>
                <Text style={styles.footerText}>
                    Noch keinen QR-Code? Wende dich an den Empfang.
                </Text>
            </View>
        </View>
    );
...
const styles = StyleSheet.create({
    ...
    scanButton: { width: '100%', borderRadius: 16, overflow: 'hidden', shadowColor: '#7A3BDF', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 8, elevation: 6 },
    scanButtonGradient: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 18, gap: 12 },
    ...
    joiningOverlay: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(0,0,0,0.7)', justifyContent: 'center', alignItems: 'center', zIndex: 10 },
    joiningText: { marginTop: 16, fontSize: 16, color: '#fff', fontWeight: '600' },
    cancelButton: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingVertical: 12, paddingHorizontal: 24, borderRadius: 12, backgroundColor: '#f3f4f6' },
