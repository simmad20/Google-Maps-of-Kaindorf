...
function NotFoundScreen() {
    return (<>
      ...
      <ThemedView_1.ThemedView style={styles.container}>
        <ThemedText_1.ThemedText style={styles.title}>This screen doesn't exist.</ThemedText_1.ThemedText>

        <expo_router_1.Link href="/" style={styles.link}>
          <ThemedText_1.ThemedText style={styles.linkText}>Go to home screen!</ThemedText_1.ThemedText>
        </expo_router_1.Link>
