...
exports.LanguageContext = (0, react_1.createContext)({
    ...
    texts: texts['de'],
    switchLanguage: function () { return null; }
});
var LanguageProvider = function (_a) {
    var children = _a.children;
    var _b = (0, react_1.useState)('de'), language = _b[0], setLanguage = _b[1];
    var switchLanguage = function () {
        console.log(language);
        setLanguage(function (prevState) { return prevState === 'de' ? 'en' : 'de'; });
    };
    return (<exports.LanguageContext.Provider value={{ language: language, oldTexts: oldTexts[language], texts: texts[language], switchLanguage: switchLanguage }}>
            {children}
        </exports.LanguageContext.Provider>);
};
