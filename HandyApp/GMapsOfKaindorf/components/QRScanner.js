...
var QRScanner = function (_a) {
    ...
    if (!permission) {
        return (<react_native_1.View style={styles.center}>
                <react_native_1.Text>Loading permission...</react_native_1.Text>
            </react_native_1.View>);
    }
    ...
    return (<react_native_1.View style={styles.overlay}>
            ...
            styles.qrFrame,
            { width: overlaySize, height: overlaySize, borderRadius: 12 },
        ]}/>
                    <react_native_1.View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.6)' }}/>
                </react_native_1.View>
                <react_native_1.View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.6)' }}/>
...
var styles = react_native_1.StyleSheet.create({
    overlay: __assign(__assign({}, react_native_1.StyleSheet.absoluteFillObject), { zIndex: 9999 }),
    closeBtn: {
        position: 'absolute',
        top: 40,
        right: 20,
